...
public class AnchorList : NetworkBehaviour
{
    ...
    void Awake()
    {
        ...
        counterName = "" + System.Char.ToUpper(consonants[Random.Range(0, consonants.Length)]) + vowels[Random.Range(0, vowels.Length)] +
            consonants[Random.Range(0, consonants.Length)];
